...
var utterances = exports.utterances = (_utterances = {
	yes: new RegExp(/((yes|yea|yup|yep|ya|sure|ok|yeah|yah|ye)|\by[esahp]{2,}\b|\bs[ure]{2,}\b|\bs[tart]{2,}\b)/i),
...
}, _defineProperty(_utterances, "containsNone", new RegExp(/\b[none]{2,}\b/i)), _defineProperty(_utterances, "containsNumber", new RegExp(/\d/i)), _utterances);
