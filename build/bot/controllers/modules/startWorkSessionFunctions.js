	...
	if (currentSession) {
		...
		if (minutesRemaining > 0) {
			(function () {
				...
				var otherTasksArray = dailyTasks.filter(function (currentDailyTask) {
				...
				var attachments = (0, _messageHelpers.getMinutesSuggestionAttachments)(minutesRemaining, config);
